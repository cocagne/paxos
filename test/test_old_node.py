...
class OldProposerTester (MTester):
...
class OldAcceptorTester (MTester):
...
class OldLearnerTester (MTester):
...
class OldNodeProposerTest(OldProposerTester, unittest.TestCase):
    Klass = node.Node

class OldNodeAcceptorTest(OldAcceptorTester, unittest.TestCase):
    Klass = node.Node

class OldNodeLearnerTest(OldLearnerTester, unittest.TestCase):
    Klass = node.Node
